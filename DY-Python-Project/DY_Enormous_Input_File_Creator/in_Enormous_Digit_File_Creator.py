...
print("\
DY Enormous Digit File Creator\n\
Author: Yusuf Shakeel\n\
Date: 09-July-2014 Wednesday\t\
Version: 1.0.0710\n\n\
...
10000000000  \t9.31   GB\n\n\
Output File name: in<YOUR_INTEGER_VALUE>.dat\n\
Example: If you entered say 1000 then output file will be in1000.dat\n\
\nWARNING!!!\n\
...
if no_of_bytes > 0:
	fname = "in"+str(no_of_bytes)+".dat"
	myfile = open(fname,'w')
	for i in range(no_of_bytes):
		myfile.write(str(randint(0,9)))
	myfile.close()
