...
print("\
DY Enormous BinaryDigit File Creator\n\
Author: Yusuf Shakeel\n\
...
--------------------------------------------------\n\
Note!\n\
This program will create enormous input file consisting 0s and 1s.\n\
...
10000000000  \t9.31   GB\n\n\
Output File name: in<YOUR_INTEGER_VALUE>bin.dat\n\
Example: If you entered say 1000 then output file will be in1000bin.dat\n\
\nWARNING!!!\n\
...
if no_of_bytes > 0:
	fname = "in"+str(no_of_bytes)+"bin.dat"
	myfile = open(fname,'w')
	for i in range(no_of_bytes):
		myfile.write(str(randint(0,1)))
	myfile.close()
